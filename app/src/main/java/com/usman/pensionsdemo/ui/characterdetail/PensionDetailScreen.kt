package com.usman.pensionsdemo.ui.characterdetail
...
@Composable
fun PensionDetailScreen(character: CharacterUiModel, padding: PaddingValues) {
    Column(
        modifier = Modifier
            .padding(padding)
            .fillMaxSize()
...
fun CharacterItemPreview(){
    ...
    PensionDetailScreen(character = uiModel, PaddingValues(dimensionResource(id = R.dimen.padding_medium)))
}